...
# need to install R packages : mvtnorm, modeltools, coin, libcoin, matrixStats, multcomp, sandwich, zoo, TH.data
#  lefse_run.py ../data/hmp_small_aerobiosis.in ../data/hmp_small_aerobiosis.res